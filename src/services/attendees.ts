...
export type AttendeesQuery = ReturnType<typeof instantDb.useQuery<{
  attendees: {};
}>>;

export type AttendeeWithAttendancesQuery = ReturnType<typeof instantDb.useQuery<{
  attendees: {
    attendances: {};
  };
}>>;

export type SingleAttendeeQuery = ReturnType<typeof instantDb.useQuery<{
  attendees: {};
}>>;
